...
class DellDetailPage extends StatefulWidget {
  final Map<String, dynamic> product;

  const DellDetailPage({Key? key, required this.product}) : super(key: key);

  @override
  _DellDetailPageState createState() => _DellDetailPageState();
}

class _DellDetailPageState extends State<DellDetailPage> {
  ...
  final List<Map<String, dynamic>> reviews = [
    {
      ...
      'rating': 4.5,
      'comment': 'Excellent performance for business use. The build quality is outstanding.',
      'date': '2023-10-15',
    },
    {
      'username': 'Sarah Wilson',
      'rating': 5.0,
      'comment': 'Perfect for my development work. Great screen and keyboard.',
      'date': '2023-10-14',
    },
  ];
